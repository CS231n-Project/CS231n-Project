...
# import pickle
#
# def load_bounding_box(path_bounding_box, path_images):
#     # load bounding boxes
#     bounding_box = pd.read_csv(path_bounding_box,
#                                delim_whitespace=True,
#                                header=None)
#     bounding_box = bounding_box.astype(int)
#
#     # load image paths
#     image_paths = pd.read_csv(path_images,
#                          delim_whitespace=True,
#                          header=None)
#     image_paths = set(image_paths[1])
#     num_image_paths = len(image_paths)
#
#     # create a dictionary path : bounding box
#     bbox_dict = {}
#     for i, path in enumerate(image_paths):
#         box = bounding_box.iloc[i][1:]
#         box = list(box)
#         bbox_dict[path[:-4]] = box
#
#     return bbox_dict
#
...
#     return filenames
#
# def load_data(bbox_dict, path):
#     with open(path, 'rb') as p:
#         filenames = pickle.load(p)
#
#
# def pickle_birds(bbox_birds, image_birds):
#     # dictionary of image file : bounding box
#     bbox_dict = load_bounding_box(bbox_birds, image_birds)
#
#
